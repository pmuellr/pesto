...
(function() {
  var SequenceNumber, SequenceNumberMax, fs, path, utils;
  ...
  utils.getSequencer = function(prefix) {
    var nextId;
...
},{"path":4,"__browserify_process":2}],5:[function(require,module,exports){
templates = module.exports

templates['content_html'] = "content!\n\ncontent!\n\ncontent!"
...
(function() {
  ...
  module.exports = Logger = (function() {
    function Logger(_arg) {
      var logObject, prefix;

      prefix = _arg.prefix, logObject = _arg.logObject;
      this._prefix = prefix;
      this._logObject = logObject;
      this._verbose = false;
      if (this._logObject == null) {
        this._logObject = console;
      }
    }
    ...
    Logger.prototype.log = function(message) {
      return this._logObject.log("" + (logDate()) + " " + this._prefix + ": " + message);
    };
    ...
    Logger.prototype.logger = function(prefix) {
      var logObject, logger;

      prefix = "" + this._prefix + ": " + prefix;
      logObject = this._logObject;
      logger = new Logger({
        prefix: prefix,
        logObject: logObject
      });
      logger.verbose(this._verbose);
      return logger;
    };

    Logger.prototype.tracer = function(fileName) {
...
},{"path":4,"./utils":3,"__browserify_process":2}],7:[function(require,module,exports){
// Generated by CoffeeScript 1.6.2
(function() {
  var $, Logger, domReady, pesto, templates, utils, _,
  ...
  domReady = function() {
    var $templates, autoloadTemplateNames, template, templateName, templateNames, _i, _len;

    $templates = $("#templates");
    for (templateName in templates) {
      if (!__hasProp.call(templates, templateName)) continue;
      template = templates[templateName];
      $templates.append("<div class='" + templateName + "'>" + template + "</div>");
    }
    autoloadTemplateNames = ["header_html", "trailer_html", "navigator_html", "content_html"];
    for (_i = 0, _len = autoloadTemplateNames.length; _i < _len; _i++) {
      templateName = autoloadTemplateNames[_i];
      $("#" + templateName).append($("#templates ." + templateName));
    }
    return templateNames = _.without(_.keys(templates), autoloadTemplateNames);
  };
